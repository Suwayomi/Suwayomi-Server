    ...
    suspend fun getManga(
        ...
        return if (!onlineFetch && mangaEntry[MangaTable.initialized]) {
            ...
            MangaDataClass(
                ...
                chaptersLastReadAt = mangaEntry[MangaTable.chaptersLastReadAt],
                chaptersLastUploadDate = mangaEntry[MangaTable.chaptersLastUploadDate],
                chaptersUnreadCount = mangaEntry[MangaTable.chaptersUnreadCount],
                chaptersTotalCount = mangaEntry[MangaTable.chaptersTotalCount],
