...
object ExtensionTable : IntIdTable() {
    ...
    val runtimeKind = varchar("runtime_kind", 16).default("JVM")
    val pluginId = varchar("plugin_id", 256).nullable()
    val siteUrl = varchar("site_url", 2048).nullable()
    val codeUrl = varchar("code_url", 2048).nullable()
    val customJsUrl = varchar("custom_js_url", 2048).nullable()
    val customCssUrl = varchar("custom_css_url", 2048).nullable()
