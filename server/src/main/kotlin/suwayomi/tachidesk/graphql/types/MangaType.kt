...
class MangaType(
    ...
    constructor(row: ResultRow) : this(
        ...
        thumbnailUrl = row[MangaTable.thumbnail_url]?.let { MangaList.proxyThumbnailUrl(row[MangaTable.id].value) },
        ...
        genre = row[MangaTable.genre].toGenreList(),
        ...
        contentType = row[MangaTable.contentType],
    )

    constructor(dataClass: MangaDataClass) : this(
        id = dataClass.id,
        sourceId = dataClass.sourceId.toLong(),
        url = dataClass.url,
        title = dataClass.title,
        thumbnailUrl = dataClass.thumbnailUrl,
        thumbnailUrlLastFetched = dataClass.thumbnailUrlLastFetched,
        initialized = dataClass.initialized,
        artist = dataClass.artist,
        author = dataClass.author,
        description = dataClass.description,
        genre = dataClass.genre,
        status = MangaStatus.valueOf(dataClass.status),
        inLibrary = dataClass.inLibrary,
        inLibraryAt = dataClass.inLibraryAt,
        updateStrategy = dataClass.updateStrategy,
        realUrl = dataClass.realUrl,
        lastFetchedAt = dataClass.lastFetchedAt,
        chaptersLastFetchedAt = dataClass.chaptersLastFetchedAt,
