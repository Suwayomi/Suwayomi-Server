...
**Note:** Keep in mind that Tachidesk is alpha software and can break rarely and/or with each update. See [Troubleshooting and Support](https://github.com/Suwayomi/Tachidesk/wiki/Troubleshooting-and-support) if it happens.
